...
- **Update** — Pull the latest OpenClaw image (`ghcr.io/wendlerc/clawnboard-moltbot:latest` by default) and restart
...
// Update to latest OpenClaw version (ghcr.io/wendlerc/clawnboard-moltbot:latest)
...
new FlyProvisioner({
  ...
  image?: string,      // Default image (default: ghcr.io/wendlerc/clawnboard-moltbot:latest)
...
| `updateMoltbot(name)` | Update to latest OpenClaw image (`ghcr.io/wendlerc/clawnboard-moltbot:latest`) |
